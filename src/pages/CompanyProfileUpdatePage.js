...
import {useGetCompanyDetailsQuery, useGetIndustriesQuery} from "../services/company";
...
const CompanyProfileUpdatePage = () => {
    ...
    const [companyDetails, setCompanyDetails] = useState({
        ...
        company_address_line_1: company?.data?.company_address_line_1 ?? null,
        ...
        company_size: company?.data?.company_size ?? null,
    });
