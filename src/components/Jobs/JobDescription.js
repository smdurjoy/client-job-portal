                            ...
                            <div className="card-body candidateAlert">
                                ...
                                <div className="content mt-4">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>{jobDescription?.no_of_vacancies}</span>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
                                ...
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>{jobDescription?.experience_requirements}</span>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>
                                                {
                                                    jobDescription?.gender_requirements ? jobDescription.gender_requirements.map(des => (
                                                        des.gender_name + ' '
                                                    )) : ''
                                                }
                                            </span>
                                ...
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>
                                                {jobDescription?.age_require_minimum} - {jobDescription?.age_require_maximum}
                                            </span>
                                        </div>
                                    </div>
                                    <hr/>
                                ...
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>{jobDescription?.industry}</span>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>{jobDescription?.certificate_course_requirements}</span>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
                                <div className="content">
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className="des">
                                            <span>{jobDescription?.job_level}</span>
                                        </div>
                                    </div>
                                    <hr/>
                                </div>
                            ...
                            <div className="card-body candidateAlert companyInfoArea">
                                ...
                                <div className="content d-flex align-items-center mt-3">
                                    ...
                                    <div>
                                        ...
                                        <span>{jobDescription.company_website}</span>
                                    </div>
                                </div>
                                <div className="content d-flex align-items-center mt-3">
