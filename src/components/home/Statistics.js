        ...
        <div className='container statisticsBanner'>
            <Grid container py={13}>
                <Grid item xs={12} md={6}>
                    <img src={rectangle3} alt='rectangle3' width='486px'/>
                </Grid>
                <Grid item xs={12} md={6}>
                    <Grid container mt={5}>
                        <Grid item xs={12} md={6} borderRight='1px solid white' borderBottom='1px solid white' pb={7}>
                        ...
                        <Grid item xs={12} md={6} borderBottom='1px solid white' pb={7}>
                            <Box display='flex' flexDirection='column' alignItems='center'>
                    ...
                    <Grid container>
                        <Grid item xs={12} md={6} borderRight='1px solid white' pt={7}>
                            <Box display='flex' flexDirection='column' alignItems='center'>
